 ...
 */
class GetLoggedinusersinRealTime extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('MyPlugin_LoggedinusersinRealTime');
        $this->dimension     = null;
        ...
        $this->subcategoryId = 'MyPlugin_LoggedinusersinRealTime';
    }
    ...
    {
        $view = new View('@MyPlugin/getLoggedinusersinRealTime');
        $view->myData = array();
