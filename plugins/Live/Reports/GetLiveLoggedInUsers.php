 ...
 */
class GetLiveLoggedInUsers extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('Live_LiveLoggedInUsers');
        $this->dimension     = null;
        ...
        $this->subcategoryId = 'Live_LiveLoggedInUsers';
    }
    ...
    {
        $view = new View('@Live/getLiveLoggedInUsers');
        $view->myData = array();
